...
Размерные константы (высота заголовка, ширина полосы, толщина сплиттера) в v1 не
токенизированы — они придут вместе с шаблонизацией лист-хрома (см. бэклог).
...
(полная замена шаблона кнопки полосы и заголовка вкладки), токены размеров, опциональный
пакет готового оформления в стиле IDEA.
