...
Кандидат следующих задач (см. [BACKLOG.md](BACKLOG.md)): опциональный пакет готового
оформления в стиле IDEA new UI — отдельным NuGet поверх токенов и `ControlTheme`.
