...
/// <summary>
/// Immutable state of the whole tool window layout: per-window states plus
/// layout-level side geometry, quick access side and the active window (spec TW-3.1).
/// </summary>
public sealed record LayoutState
{
    /// <summary>Empty layout: no tool windows, default side geometry.</summary>
