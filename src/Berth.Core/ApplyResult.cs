...
/// corrections (spec TW-10.4, DA-9.2). An application wanting «a proper layout or nothing»
/// builds its strict mode on top of the report — apply, then reject the result when
/// <see cref="Fixes"/> is non-empty; strictness is an application policy, not a core one.
/// </summary>
